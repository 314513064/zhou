...
public interface MaterialService {
		...
		public boolean send_Material(List<Long>user_ids,Long material_id,
				Long caseId,String casesummery,String username,Long operation_id);
		...
		public List<Object> getMaterials(Long operation_id, int material_type, Long userid,
				QueryInfo queryInfo);
}
