...
<div class="wrap">
    ...
    <div class="nav">
        <div><a href="javascript:void(0);"><span class="glyphicon glyphicon-time"></span>任务</a></div>
    ...
    $('#submit').on('click', function () {
        ...
        $('form').on('submit', function () {
            ...
            $(this).ajaxSubmit({
                ...
                url: 'case/${casee.id}/operation/${operation_id}/material?file_type=1&flag_output=1', // 需要提交的 url
