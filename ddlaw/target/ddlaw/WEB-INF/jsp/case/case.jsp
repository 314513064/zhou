...
<div class="wrap">
    ...
    <div class="newCaseItem">
        <form action="case/new_step1" method="post">
            <div class="caseInfo">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea name="summary" id="reason" placeholder="请输入案由">
                            	${casee.summary}
                            </textarea>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="glyphicon glyphicon-calendar"></span>
                            <input type="date" class="form-control" name="termtime" id="proofTime"/>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <c:forEach items="${trusteeoppositions}" var ="trusteeopposition">
                 <c:if test="${trusteeopposition==0}">
...
<script>
    $(function () {
        ...
        if ($(this).html()=='${casee.level}'){
        $(this).prop('selected','selected');
        }
        });
    var setTime = function(Mytime){
        var time1 = Mytime;
    ...
    $("#openTime").val(setTime('${casee.opentime}'));
    $("#proofTime").val(setTime('${casee.termtime}'));
    })
</script>
