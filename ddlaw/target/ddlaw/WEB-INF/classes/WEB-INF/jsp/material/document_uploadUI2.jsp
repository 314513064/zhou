...
<body>
	<div class="wrap">
		...
		<div class="setHeader">
			<a href='javascript:;' onClick='javascript :history.back(-1);'><span
		...
		<div id="materialUpload">
			<form enctype="multipart/form-data">
				...
				<h3>
					文档上传 <i style="font-size: 0.5rem; color: #cccccc">(仅限.doc,.docx,.pdf,.txt格式)</i>
				</h3>
				...
				<div class="selectType" style="clear: both">
					<label for="type">上传类型</label> <select name="type" id="type"
						class="form-control">
